...
string Assembler::generateMachineCode(SymbolTable* symbolTable, string instructions[], int numOfInst) {
    ...
    for (int i = 0; i < numOfInst; i++)
    {
        if (parseInstructionType(instructions[i]) == A_INSTRUCTION)
        {
            ...
            code += translateSymbol(parseSymbol(instructions[i]), symbolTable);
...
string Assembler::translateDest(InstructionDest dest) {
    ...
    map<InstructionDest, string> dests;

    dests.insert(pair<InstructionDest, string> (A, "100"));
    dests.insert(pair<InstructionDest, string> (D, "010"));
    dests.insert(pair<InstructionDest, string> (M, "001"));
    dests.insert(pair<InstructionDest, string> (AM, "101"));
    dests.insert(pair<InstructionDest, string> (AD, "110"));
    dests.insert(pair<InstructionDest, string> (MD, "011"));
    dests.insert(pair<InstructionDest, string> (AMD, "111"));
    dests.insert(pair<InstructionDest, string> (NULL_DEST, "000"));

    if (dests.count(dest) > 0)
    {
...
string Assembler::translateJump(InstructionJump jump) {
    ...
    map<InstructionJump, string> jumps;

    jumps.insert(pair<InstructionJump, string> (NULL_JUMP, "000"));
    jumps.insert(pair<InstructionJump, string> (JGT, "001"));
    jumps.insert(pair<InstructionJump, string> (JEQ, "010"));
    jumps.insert(pair<InstructionJump, string> (JGE, "011"));
    jumps.insert(pair<InstructionJump, string> (JLT, "100"));
    jumps.insert(pair<InstructionJump, string> (JNE, "101"));
    jumps.insert(pair<InstructionJump, string> (JLE, "110"));
    jumps.insert(pair<InstructionJump, string> (JMP, "111"));

    if (jumps.count(jump) > 0)
    {
...
string Assembler::translateComp(InstructionComp comp) {
    ...
    map<InstructionComp, string> comps;

    comps.insert(pair<InstructionComp, string> (CONST_0, "0101010"));
    comps.insert(pair<InstructionComp, string> (CONST_1, "0111111"));
    comps.insert(pair<InstructionComp, string> (CONST_NEG_1, "0111010"));
    comps.insert(pair<InstructionComp, string> (VAL_D, "0001100"));
    comps.insert(pair<InstructionComp, string> (VAL_A, "0110000"));
    comps.insert(pair<InstructionComp, string> (NOT_D, "0001101"));
    comps.insert(pair<InstructionComp, string> (NOT_A, "0110001"));
    comps.insert(pair<InstructionComp, string> (NEG_D, "0001111"));
    comps.insert(pair<InstructionComp, string> (NEG_A, "0110011"));
    comps.insert(pair<InstructionComp, string> (D_ADD_1, "0011111"));
    comps.insert(pair<InstructionComp, string> (A_ADD_1, "0110111"));
    comps.insert(pair<InstructionComp, string> (D_SUB_1, "0001110"));
    comps.insert(pair<InstructionComp, string> (A_SUB_1, "0110010"));
    comps.insert(pair<InstructionComp, string> (D_ADD_A, "0000010"));
    comps.insert(pair<InstructionComp, string> (D_SUB_A, "0010011"));
    comps.insert(pair<InstructionComp, string> (A_SUB_D, "0000111"));
    comps.insert(pair<InstructionComp, string> (D_AND_A, "0000000"));
    comps.insert(pair<InstructionComp, string> (D_OR_A, "0010101"));
    comps.insert(pair<InstructionComp, string> (VAL_M, "1110000"));
    comps.insert(pair<InstructionComp, string> (NOT_M, "1110001"));
    comps.insert(pair<InstructionComp, string> (NEG_M, "1110011"));
    comps.insert(pair<InstructionComp, string> (M_ADD_1, "1110111"));
    comps.insert(pair<InstructionComp, string> (M_SUB_1, "1110010"));
    comps.insert(pair<InstructionComp, string> (D_ADD_M, "1000010"));
    comps.insert(pair<InstructionComp, string> (D_SUB_M, "1010011"));
    comps.insert(pair<InstructionComp, string> (M_SUB_D, "1000111"));
    comps.insert(pair<InstructionComp, string> (D_AND_M, "1000000"));
    comps.insert(pair<InstructionComp, string> (D_OR_M, "1010101"));
...
string Assembler::translateSymbol(string symbol, SymbolTable* symbolTable) {
    ...
    {
        int dec = symbolTable->getSymbol(symbol);
